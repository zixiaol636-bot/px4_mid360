#!/usr/bin/env python3
"""Launch Livox MID360 driver and a point-cloud watchdog."""
...
def generate_launch_description():
    ...
    config_arg = DeclareLaunchArgument(
        ...
        description="Absolute path to Livox MID360_config.json",
    )
    ...
    watchdog_timeout_arg = DeclareLaunchArgument(
        "watchdog_timeout",
        default_value="2.0",
        description="Seconds without point clouds before /driver/health becomes false",
    )
    ...
    driver_monitor_node = Node(
        ...
        parameters=[{
            ...
            "watchdog_timeout": ParameterValue(
                LaunchConfiguration("watchdog_timeout"), value_type=float),
            "check_rate": 10.0,
            "publish_health": True,
            "health_topic": "/driver/health",
        }],
    )
    ...
    exit_handler = RegisterEventHandler(
        OnProcessExit(
            ...
            on_exit=[
                LogInfo(msg="livox_ros_driver2 exited; shutting down MID360 launch."),
